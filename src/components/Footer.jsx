      ...
      <footer className="bg-gray-500 text-white py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start text-center md:text-left gap-8">
          ...
          <div className="flex space-x-4">
            ...
            <a href="https://www.facebook.com/profile.php?id=100072807586539" rel="noopener noreferrer" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
            ...
            <a href="https://www.facebook.com/profile.php?id=100072807586539" rel="noopener noreferrer" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 30 30">
